...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/v1/teams/{id}/schedule/l1-groups": {
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Groups of user IDs",
                        "name": "groups",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api.SetGroupsRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/teams/{id}/schedule/l2-users": {
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api.SetUsersRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "api.ScheduleRequest": {
            ...
            "properties": {
                ...
                "l1_rotation_start": {
                    "description": "e.g., 2025-01-01T11:00:00Z",
                    "type": "string"
                },
                "l1_rotation_type": {
                    "description": "\"daily\" | \"weekly\"",
                ...
                "l2_enabled": {
                    "description": "Enable L2 layer",
                    "type": "boolean"
                },
                "l2_escalation_timeout": {
                ...
                "slack_usergroup_id": {
                    "description": "Optional Slack usergroup for on-call sync",
                    "type": "string"
                },
                "timezone": {
        ...
        "api.SetGroupsRequest": {
            ...
            "properties": {
                "groups": {
                    "description": "Groups of user IDs, e.g. [[\"id1\",\"id2\"],[\"id3\"]]",
                    "type": "array",
                    "items": {
                        "type": "array",
                        "items": {
        ...
        "model.OnCallResult": {
            ...
            "properties": {
                ...
                "override": {
                    "description": "If override is active",
                    "allOf": [
                        {
        ...
        "model.Schedule": {
            ...
            "properties": {
                ...
                "l1_handoff_day": {
                    "description": "0=Sun, 1=Mon (for weekly)",
                    "type": "integer"
                },
                "l1_handoff_time": {
                    "description": "\"11:00\" format",
                    "type": "string"
                },
                "l1_rotation_start": {
                    "description": "When rotation started",
                    "type": "string"
                },
                "l1_rotation_type": {
                    "description": "L1 Layer Config (Primary)",
                    "allOf": [
                        {
                            "$ref": "#/definitions/model.RotationType"
                        }
                    ]
                },
                "l2_enabled": {
                    "description": "L2 Layer Config (Secondary, optional)",
                    "type": "boolean"
                },
                "l2_escalation_timeout_min": {
                    "description": "Minutes before escalating to L2",
                    "type": "integer"
                },
                "l2_handoff_day": {
                    "type": "integer"
                ...
                "slack_usergroup_id": {
                    "description": "Slack Usergroup Sync (optional)",
                    "type": "string"
                },
                "team_id": {
                    "type": "string"
