...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/v1/deliveries/{id}/decisions": {
            "post": {
    ...
    "definitions": {
        ...
        "api.AlertGroupDeliveriesResponse": {
            ...
            "properties": {
                ...
                "paging": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/api.GroupDeliveryDTO"
                    }
                }
            }
        },
        ...
        "api.DecisionRequest": {
            ...
            "properties": {
                "accepted_duplicate_risk": {
                    "description": "AcceptedDuplicateRisk is the person saying, on the record, that a second\nmessage may exist. Some decisions need it; the refusal says so.",
                    "type": "boolean"
                },
                "decision": {
                    "description": "Decision is one of assume_accepted, cancel, retry_current_generation,\nretry_new_generation.",
                    "type": "string"
                },
                "new_expires_at": {
                    "description": "NewExpiresAt is the new deadline a retry of an expired commitment needs.\nIt has to be ahead of the moment it is written.",
                    "type": "string"
                },
                "reason": {
                    "description": "Reason is required: a decision without one is \"somebody decided\nsomething\". At most 500 characters, counted as characters.",
                    "type": "string"
                }
            }
        },
        "api.DecisionResponse": {
            ...
            "properties": {
                "delivery": {
                    "description": "Delivery is the commitment after the decision applied.",
                    "allOf": [
                        {
                ...
                "detail": {
                    "description": "Detail is the words of the guard that refused the decision.",
                    "type": "string"
                },
                "outcome": {
                    "type": "string"
                ...
                "row": {
                    "description": "Row is the line of the decision table that applied.",
                    "type": "string"
                },
                "status": {
                    "description": "Status is where the commitment stands after the answer - the new state\nwhen the decision applied, the current one when it did not.",
                    "type": "string"
                }
            }
        },
        ...
        "api.DeliveryEventDTO": {
            ...
            "properties": {
                ...
                "actor_kind": {
                    "description": "ActorKind says what Actor is: the id of a user, the name of a component, or the text of a build before this one.",
                    "type": "string"
                },
                "at": {
                    "type": "string"
