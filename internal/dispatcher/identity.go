...
// external_identities. After Sprint 4 (Epic 7 L7) it is fully generic — no
// per-provider switch — so adding Telegram does not require touching this
// function. The previous `default → ErrNoIdentityResolver` branch is gone
