...
func TestAnAdmissionThatPromisedNothingIsCountedAsSuch(t *testing.T) {
	cases := []struct {
		...
		{outbound.SubmitCreated, 3, "created"},
		{outbound.SubmitCreated, 0, "no_targets"},
		{outbound.SubmitExisting, 3, "existing"},
		{outbound.SubmitConflict, 3, "conflict"},
		{outbound.SubmitSourceChanged, 3, "source_changed"},
		{outbound.SubmitGroupNotAdmitted, 3, "group_not_admitted"},
		...
		// twice for one alert.
		{outbound.SubmitExisting, 0, "existing"},
	}
